...
public class XMLDeclarationOptImpl extends ASTWrapperPsiElement implements XMLDeclarationOpt {

  public XMLDeclarationOptImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull XMLVisitor visitor) {
    visitor.visitDeclarationOpt(this);
  }
